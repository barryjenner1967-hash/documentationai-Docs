...
Please read through our explaination webpage: <a href="https://zettelkasten.online" target="_blank" rel="noopener noreferrer">https\://zettelkasten.online</a> and the Zettelkasten Concepts page at: <a href="https://docs.minddump.uk/niklas-luhmann---zettelkasten" target="_blank" rel="noopener noreferrer">https\://docs.minddump.uk/niklas-luhmann---zettelkasten</a>&#x20;
...
1. Open the Zettelkasten app from the side bar of the main view.

2. Navigate and drop down the Menu Button, towards the top right of the screen.&#x20;

3. Select 'Create New Zettelkasten' from the menu.&#x20;

4. In the Create New Zettelkasten modal, enter a name for your new Zettelkasten, this should clearly identify its purpose so you know what it is in the future.&#x20;

5. Select a template for creating a brand new Zettelkasten. When starting out, we strongly advise you should select the Academic Discaplines.

6. In the next modal, you can change the names and add root nodes. When starting out, we strongly recommend that you just accept the template structure as it is.
...
- **Luhmann Notes (Latex/MD Type) these are your Atomic Notes:** A rich-text editor for drafting your atomic claims in your own words, complete with LaTeX support for complex formatting.

- **The Consequence:** In the Zettelkasten, we seek the ultimate meaning or consequence of the Atomic Note or Luhmann Note. This field is used to store the consequential meaning of Atomic Notes.&#x20;
...
<Image src="https://blob-cdn.documentation.ai/org-345aafe0-d05f-4ea0-a0d8-da85a24de9e7/doc-2dc7c9b9-c923-475b-b613-93f57e86164f/1782113097667-ow5ad4tdvx-Screenshot-2026-06-22-082431.png?fm=auto&auto=compress%2Cformat" width="1911" height="1561" alt="" />
