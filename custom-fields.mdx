...
- **Serial Number:** An auto-generating numeric field that automatically increments for each new record created within the session. You can configure a custom prefix and a specific starting number, making it perfect for automatically generating unique identifiers like invoice numbers, support tickets, or asset tags
