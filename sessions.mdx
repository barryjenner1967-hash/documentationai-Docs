...
When you create a brand-new Session, it starts off as a blank slate. To make it useful, you need to define what kind of information belongs inside it. You do this using **Custom Fields (**[**learn more here**](/custom-fields)**)**.
